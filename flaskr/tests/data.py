...
def seed_data(db):
    ...
    db.session.add(
        Album(id=4, titulo='Aral, Fishing in an Invisible Sea', anio=1999, descripcion='grow virtual communities',
              usuario=4))
    ...
    db.session.add(Album(id=7, titulo='101 Dalmatians II: Patch''s London Adventure', anio=2006,
                         descripcion='extend enterprise e-tailers', usuario=7))
    db.session.add(
        Album(id=8, titulo='Time for Killing, A', anio=1996, descripcion='enhance seamless portals', usuario=8))
    ...
    db.session.add(
        Album(id=12, titulo='Outbreak', anio=2000, descripcion='integrate e-business technologies', usuario=2))
    db.session.add(
        Album(id=13, titulo='Three Musketeers, The', anio=2010, descripcion='innovate interactive portals', usuario=1))
    db.session.add(Album(id=14, titulo='Presumed Guilty (Presunto culpable)', anio=2003,
                         descripcion='visualize wireless experiences', usuario=2))
    db.session.add(Album(id=15, titulo='I Am Curious (Yellow) (Jag är nyfiken - en film i gult)', anio=2007,
                         descripcion='synergize user-centric partnerships', usuario=5))
    db.session.add(
        Album(id=16, titulo='Rage (Rabia)', anio=2002, descripcion='whiteboard intuitive bandwidth', usuario=6))
    db.session.add(
        Album(id=17, titulo='Heaven''s Gate', anio=1995, descripcion='expedite transparent methodologies', usuario=3))
    db.session.add(
        Album(id=18, titulo='Low Down Dirty Shame, A', anio=2007, descripcion='synthesize sticky metrics', usuario=18))
    db.session.add(Album(id=19, titulo='Saw V', anio=1991, descripcion='visualize magnetic communities', usuario=5))
    db.session.add(Album(id=20, titulo='Kevin Smith: Sold Out - A Threevening with Kevin Smith', anio=1993,
    ...
    db.session.add(ComentarioModel( descripcion="Comentario de prueba numero 3", album_id=1, user_id=2))
    db.session.add(ComentarioModel( descripcion="Comentario de prueba numero 4", album_id=1, user_id=2))
    db.session.add(ComentarioModel( descripcion="Comentario de prueba numero 5", album_id=2, user_id=1))
    db.session.add(ComentarioModel( descripcion="Comentario de prueba numero 6", album_id=2, user_id=1))
    db.session.add(ComentarioModel( descripcion="Comentario de prueba numero 7", album_id=2, user_id=1))
    db.session.add(ComentarioModel( descripcion="Comentario de prueba numero 8", album_id=2, user_id=2))
    db.session.add(ComentarioModel( descripcion="Comentario de prueba numero 9", album_id=2, user_id=2))
    db.session.add(ComentarioModel( descripcion="Comentario de prueba numero 10", album_id=2, user_id=3))
